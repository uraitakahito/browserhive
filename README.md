...
Every CLI flag has a `BROWSERHIVE_*` env-var equivalent (resolution order: **CLI flag > env var > default**). See [docs/environment-variables.md](docs/environment-variables.md) for the full CLI flag ↔ env var mapping.
